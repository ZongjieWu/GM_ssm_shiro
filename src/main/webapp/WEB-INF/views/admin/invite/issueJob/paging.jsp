...
//                    ,templet:"#nameDemo"
                ...
                ,{field: 'enterpriseName',width:"10%",  align:'center', title: '企业'
//                    ,templet:"#imgTpl"
                }
//                ,{field: 'workPlace' ,width:"10%",align:'center', title: '工作地点'}
                ,{field: 'workAge' ,width:"10%",align:'center', title: '工龄'}
                ,{field: 'edu' ,width:"10%",align:'center', title: '学历'}
        ...
        table.on('tool(demo)', function(obj){
            ...
            if (obj.event === 'detail') {
                popUpBox = layer.open({
                    ...
                    maxmin: true,
                    title: '发布职位详情',
                    content:'<%=path%>/invite/issueJob/jumpDetail?id='+data.id
                })
            }
            // 通过
            if (obj.event === 'update') {
