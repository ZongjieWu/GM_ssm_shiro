    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="remitAuthenticationTpl">
                ...
                <img class="remitAuthentication" style="display: inline-block; width: 100%; height: 100%;" src= "<%=path%>/static/upload/image/blank.jpg">
                {{# } }}
                {{#if (d.remitAuthentication!=null && d.remitAuthentication != '' ) { }}
                <img class="remitAuthentication" style="display: inline-block; width: 100%; height: 200%;" src= "<%=path%>/{{ d.remitAuthentication }}">
                {{# } }}
                <div class="layui-col-xs4 layui-col-sm12 layui-col-md4">
                    <div class="magnifier-preview" id="gallery-preview" style="width:400px;height:800px;">
                    </div>
                </div><!--预览图容器-->
...
<script>
    ...
    layui.config({
        base: '<%=path%>/static/Magnifier/' //假设这是你存放拓展模块的根目录
    }).extend({
    ...
    layui.use(['layer', 'form','Event','Magnifier'], function(){
        ...
        Magnifier.attach({
            thumb: '.remitAuthentication',//需要使用放大镜的图片元素（#id || .class）
            zoom:3,//缩放比例
        });
    ...
    layui.use(['form','layer','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'enterpriseLogo',width:"10%",  align:'center', title: '头像'
                    ,templet:"#imgTpl"
                }
                ,{field: 'enterpriseName',width:"10%",  align:'center', title: '企业名称'
//                    ,templet:"#nameDemo"
                }
                ,{field: 'enterprisePhone' ,width:"10%",align:'center', title: '企业账号'}
                ,{field: 'remitAuthentication' ,width:"13%",align:'center', title: '打款凭证',templet:"#remitAuthenticationTpl"}
//                ,{field: 'serviceType' ,width:"8%",align:'center', title: '服务类型'}
                ,{field: 'status' ,width:"12%",align:'center', title: '审核状态',templet:"#statusTpl"}
                ,{field: 'addTime' ,width:"15%",align:'center', title: '申请时间'}
