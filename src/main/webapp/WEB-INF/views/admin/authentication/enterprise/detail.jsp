                    ...
                    <div class="layui-form" wid100 lay-filter="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <c:if test="${enterprise.logo==null || enterprise.headImg==''}">
                                    <img id="headImg" name="headImg" src="<%=path%>/static/upload/image/blank.jpg" style="width: 7%;height: 14%;">
                                </c:if>
                                <c:if test="${enterprise.headImg!=null && enterprise.headImg!=''}">
                                    <img id="headImg" name="headImg" src="<%=path%>/${enterprise.headImg}" style="width: 7%;height: 14%;">
                                </c:if>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block"  id="test2">
                                ...
                                <c:if test="${enterprise.legalIdCard!=null && enterprise.legalIdCard!=''}">
                                    <img id="idCard" name="idCard" src="<%=path%>/${enterprise.legalIdCard}" style="width: 7%;height: 14%;">
                                </c:if>
                            </div>
                        </div>
                        <div class="layui-form-item">
